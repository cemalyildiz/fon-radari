...
export const metadata: Metadata = {
  ...
  description:
    "TÜBİTAK, KOSGEB, Horizon Europe, LIFE ve EIC proje çağrılarını tarih, destek türü, bütçe ve başvuru koşullarıyla keşfedin.",
  metadataBase: new URL("https://cemalyildiz.github.io/fon-radari/"),
  openGraph: {
    title: "Fon Radarı",
    description: "Güncel proje çağrılarını tek ekranda keşfedin.",
    type: "website",
